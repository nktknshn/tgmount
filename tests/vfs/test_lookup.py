...
from tgmount.vfs import vfile, vdir, text_content, root
...
#     assert await get_by_path_str(structure, "folder1/subfolder1/text4.txt") is file4
#     assert await get_by_path_str(structure, "folder1/text1.txt/text4.txt") is None
