...
from tests.util import ZipSourceTree, create_zip_from_tree
...
def test_fs_zip1(tmpdir: str, zip_tree1: ZipSourceTree):
    ...
    vfs_root = vfs.root(
        {
            ...
            "telegram": {"channel 010101": {"music.zip": file_content_from_io(zb)}},
        }
    )
